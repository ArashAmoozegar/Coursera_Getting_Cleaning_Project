...
# Part 2: Loading Activity Labels and Features data sets to R
act_labels <- read.table("UCI HAR Dataset/activity_labels.txt")
act_labels[,2] <- as.character(act_labels[,2])
features <- read.table("UCI HAR Dataset/features.txt")
features[,2] <- as.character(features[,2])

# Part 3: Extracting only the measurements on the mean and standard deviation for each measurement
...
# Part 4: Loading Test and Train data sets to R and merging them
...
# Part 6: Exporting the tidy data set
